...
<div class="container py-4">
  <h4 class="mb-3">Add Course & Assign Teacher</h4>
  ...
  <table class="table table-striped">
    <thead><tr><th>ID</th><th>Name</th><th>Teacher ID</th></tr></thead>
    <tbody>
    <%
      for (var c : dao.getAll()) {
    %>
      <tr><td><%= c.getId() %></td><td><%= c.getCourseName() %></td><td><%= c.getTeacherId() %></td></tr>
    <% } %>
    </tbody>
  </table>
</div>
